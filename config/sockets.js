...
module.exports.sockets = {
  ...
  // onConnect: async (session, socket) => {
  //   console.log("connected from the other siiiide");
  //   sails.sockets.broadcast('serverMessage', 'customMessage', { message: 'hi' });
    
   
  // },
  onClientMessage: async (message, socket) => {
